...
public class Main
{
    ...
    {
    	if((args.length > 0 && !args[0].equalsIgnoreCase("--nogui")) || args.length == 0) {
        ...
        if ( args.length != 4 )
        {
            ...
            System.out.println( "In order to use this tool you will need to specify four command line arguments as follows:" );
            System.out.println( "\tjava -jar SpigotPatcher.jar --nogui original.jar patch.bps output.jar" );
